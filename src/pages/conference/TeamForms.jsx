      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            <a 
              href="https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/67d1775786feb0b1dfc8f089.pdf" 
              target="_blank" 
              rel="noopener noreferrer" 
              className="bg-black text-white px-6 py-3 rounded-full inline-block hover:bg-gray-800 transition"
            >
        ...
        <div className="bg-gray-50 p-8 rounded-lg">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <a 
              href="https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/67d177f86028545afcbb1be2.pdf" 
              target="_blank" 
              rel="noopener noreferrer" 
