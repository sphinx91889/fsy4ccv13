...
export default function Navbar() {
  ...
  const conferenceMenuItems = [
    ...
    { title: 'Hotel/Lodging Information', path: '/conference/hotel' },
    ...
    <nav className="fixed w-full z-50 top-0 bg-white/95 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Social & CTA - Updated with correct links */}
        ...
        {isOpen && (
          <div className="md:hidden bg-white">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <Link to="/" onClick={handleLinkClick} className="nav-link block px-3 py-2 text-gray-800 hover:text-gray-600">HOME</Link>
              <Link to="/conference" onClick={handleLinkClick} className="nav-link block px-3 py-2 text-gray-800 hover:text-gray-600">2025 CONFERENCE</Link>
              {conferenceMenuItems.map((item) => (
                <Link
                  key={item.path}
                  to={item.path}
              ...
              <Link to="/gallery" onClick={handleLinkClick} className="nav-link block px-3 py-2 text-gray-800 hover:text-gray-600">GALLERY</Link>
              <Link to="/about" onClick={handleLinkClick} className="nav-link block px-3 py-2 text-gray-800 hover:text-gray-600">ABOUT</Link>
              <Link to="/contact" onClick={handleLinkClick} className="nav-link block px-3 py-2 text-gray-800 hover:text-gray-600">CONTACT</Link>
